 ...
 void MagicTowerV1::buildingAnimation()
 {
	...
	hpBar->runAction(Sequence::create(ProgressTo::create(0.5f, 100)
		, CallFuncN::create(CC_CALLBACK_0(Sprite::removeFromParent, building))
                                           , NULL));
	scheduleOnce(schedule_selector(MagicTowerV1::buildingSmokeAnimation),0.5f);
 }

 void MagicTowerV1::buildingSmokeAnimation(float dt)
{
...
Bullet* MagicTowerV1::MageTowerBullet()
{
